...
def TGDAnet_main():
    ...
    ## 1.1 Data parameters
    parser.add_argument('--path',    type=str,   default='/home/qinxuexiang/00_Github_Work/TGDAnet_CD/Code/', help="The root path of the project.")
    parser.add_argument('--folder',  type=str,   default='/home/qinxuexiang/00_Github_Work/TGDAnet_CD/Data/', help='The path where the dataset is stored')
    parser.add_argument('--method',  type=str,   default='TGDAnet',                                           help='The name of the method.')
    parser.add_argument('--source',  type=str,   default='USA',                                               help='The name of the source domain dataset.')
    parser.add_argument('--target',  type=str,   default='China',                                             help='The name of the target domain dataset.')
    ...
    parser.add_argument('--lambda1', type=float, default=1e-4,                                                help='The loss weighting for domain adaptation.')
    parser.add_argument('--lambda2', type=float, default=1e-3,                                                help='The loss weighting for text.')
...
=============== Start ===============
===== USA Transform to China =====
    seed: 1024; lambda1: 0.0001; lambda2: 0.001;
    Source: USA;  Source shape: (307, 241, 154);  Source class: 2;
    Train samples: 1850;  Valid samples: 7399
    Target: China;  Target shape: (450, 140, 155);  Target class: 2;
    Train samples: 1575;  Valid samples: 6300
===== Train =====
    Epoch: 10/50; Src_Train Loss: 0.1338; Src_Train IoU: 79.11; Src_Train Ka: 0.8495; Src_Valid Loss: 0.2238; Src_Valid IoU: 71.03; Src_Valid Ka: 0.7736;
    Epoch: 20/50; Src_Train Loss: 0.1009; Src_Train IoU: 86.33; Src_Train Ka: 0.9050; Src_Valid Loss: 0.1478; Src_Valid IoU: 79.77; Src_Valid Ka: 0.8543;
    Epoch: 30/50; Src_Train Loss: 0.0804; Src_Train IoU: 88.78; Src_Train Ka: 0.9242; Src_Valid Loss: 0.1330; Src_Valid IoU: 81.18; Src_Valid Ka: 0.8672;
    Epoch: 40/50; Src_Train Loss: 0.0653; Src_Train IoU: 89.59; Src_Train Ka: 0.9297; Src_Valid Loss: 0.1483; Src_Valid IoU: 80.80; Src_Valid Ka: 0.8645;
    Epoch: 50/50; Src_Train Loss: 0.0771; Src_Train IoU: 88.02; Src_Train Ka: 0.9175; Src_Valid Loss: 0.1353; Src_Valid IoU: 81.23; Src_Valid Ka: 0.8666;
===== Test =====
    Total samples:  63000
===== The Final Accuracy for Evaluation. =====
    Time: 587.60s
    IoU: 86.25% | F1: 92.62% | OA: 95.54% | Kappa: 0.8943 | Precision: 0.8901 | Recall: 0.9653
