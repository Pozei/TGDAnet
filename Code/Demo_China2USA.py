...
def TGDAnet_main():
    ...
    parser.add_argument('--source',  type=str,   default='China',                                             help='The name of the source domain dataset.')
    parser.add_argument('--target',  type=str,   default='USA',                                               help='The name of the target domain dataset.')
    ...
    ## 1.5     device = torch.device('cuda:' + args.cuda if torch.cuda.is_available() else 'cpu')
...
"""
=============== Start ===============
===== China Transform to USA =====
    seed: 1024; lambda1: 0.0001; lambda2: 0.001;
    Source: China;  Source shape: (450, 140, 155);  Source class: 2;
    Train samples: 1575;  Valid samples: 6300
    Target: USA;  Target shape: (307, 241, 154);  Target class: 2;
    Train samples: 1850;  Valid samples: 7399
===== Train =====
    Epoch: 10/50; Src_Train Loss: 0.0905; Src_Train IoU: 88.66; Src_Train Ka: 0.9150; Src_Valid Loss: 0.1260; Src_Valid IoU: 86.35; Src_Valid Ka: 0.8942;
    Epoch: 20/50; Src_Train Loss: 0.0619; Src_Train IoU: 92.32; Src_Train Ka: 0.9435; Src_Valid Loss: 0.0900; Src_Valid IoU: 90.25; Src_Valid Ka: 0.9270;
    Epoch: 30/50; Src_Train Loss: 0.0327; Src_Train IoU: 96.25; Src_Train Ka: 0.9731; Src_Valid Loss: 0.0883; Src_Valid IoU: 90.56; Src_Valid Ka: 0.9300;
    Epoch: 40/50; Src_Train Loss: 0.0266; Src_Train IoU: 97.78; Src_Train Ka: 0.9842; Src_Valid Loss: 0.1026; Src_Valid IoU: 89.66; Src_Valid Ka: 0.9223;
    Epoch: 50/50; Src_Train Loss: 0.0158; Src_Train IoU: 98.44; Src_Train Ka: 0.9889; Src_Valid Loss: 0.0897; Src_Valid IoU: 91.15; Src_Valid Ka: 0.9345;
===== Test =====
    Total samples:  73987
===== The Final Accuracy for Evaluation. =====
    Time: 757.89s
    IoU: 76.38% | F1: 86.61% | OA: 94.09% | Kappa: 0.8281 | Precision: 0.8845 | Recall: 0.8484
