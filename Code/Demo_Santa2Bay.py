...
def TGDAnet_main():
    ...
    parser.add_argument('--source',  type=str,   default='Santa',                                             help='The name of the source domain dataset.')
    parser.add_argument('--target',  type=str,   default='Bay',                                               help='The name of the target domain dataset.')
    ...
    parser.add_argument('--lambda1', type=float, default=1e-1,                                                help='The loss weighting for domain adaptation.')
    parser.add_argument('--lambda2', type=float, default=1e-1,                                                help='The loss weighting for text.')
...
=============== Start ===============
===== Santa Transform to Bay =====
    seed: 1024; lambda1: 0.1; lambda2: 0.1;
    Source: Santa;  Source shape: (984, 740, 224);  Source class: 2;
    Train samples: 3313;  Valid samples: 13255
    Target: Bay;  Target shape: (600, 500, 224);  Target class: 2;
    Train samples: 1837;  Valid samples: 7348
===== Train =====
    Epoch: 10/50; Src_Train Loss: 0.0648; Src_Train IoU: 94.44; Src_Train Ka: 0.9529; Src_Valid Loss: 0.0675; Src_Valid IoU: 95.35; Src_Valid Ka: 0.9611;
    Epoch: 20/50; Src_Train Loss: 0.0441; Src_Train IoU: 96.31; Src_Train Ka: 0.9687; Src_Valid Loss: 0.0524; Src_Valid IoU: 96.67; Src_Valid Ka: 0.9724;
    Epoch: 30/50; Src_Train Loss: 0.0461; Src_Train IoU: 97.88; Src_Train Ka: 0.9823; Src_Valid Loss: 0.0491; Src_Valid IoU: 97.26; Src_Valid Ka: 0.9770;
    Epoch: 40/50; Src_Train Loss: 0.0416; Src_Train IoU: 96.98; Src_Train Ka: 0.9748; Src_Valid Loss: 0.0304; Src_Valid IoU: 98.21; Src_Valid Ka: 0.9851;
    Epoch: 50/50; Src_Train Loss: 0.0149; Src_Train IoU: 98.68; Src_Train Ka: 0.9891; Src_Valid Loss: 0.0258; Src_Valid IoU: 98.56; Src_Valid Ka: 0.9880;
===== Test =====
    Total samples:  73481
===== The Final Accuracy for Evaluation. =====
    Time: 1255.02s
    IoU: 90.52% | F1: 95.03% | OA: 94.79% | Kappa: 0.8957 | Precision: 0.9710 | Recall: 0.9304
